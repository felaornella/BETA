...
class Publicacion(db.Model):
    ...
    def allEnabledPerdidosYEncontrados():
        return (
            Publicacion.query.filter_by(enabled=True, tipo=1, estadoGeneral=1).all()
            + Publicacion.query.filter_by(enabled=True, tipo=2, estadoGeneral=1).all()
        )

    def allEnabledAdopcionYTransito():
        return (
            Publicacion.query.filter_by(enabled=True, tipo=3, estadoGeneral=1).all()
            + Publicacion.query.filter_by(enabled=True, tipo=4, estadoGeneral=1).all()
        )
    ...
    def __repr__(self):
        return "<Publicacion {0} {1} {2} {3} {4} {5} {6}>".format(
            self.nombre,
            self.raza_mascota,
            self.tipo_mascota,
            self.publicador,
    ...
    def to_dict(self):
        ...
        return {
            ...
            if self.publicador is not None
                ...
                "email_visible": False,
                "telefono_visible": self.contacto_anonimo is not None,
                "telefono": self.contacto_anonimo,
            },
