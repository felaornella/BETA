...
from app.resources.publicaciones import (
    validarRequestNuevaPublicacion,
    validarRequestMascota,
)
...
def create_app(environment=env):
    ...
    def check_forced_logout():
        try:
            if not current_user.is_authenticated:
                return (
                    jsonify({"message": "Sin Autorización"}),
                    401,
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Server Error: Codigo 1743"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def login():
        try:
            ...
            if email is None or email == "":
                return (
                    jsonify({"msg": "El email es obligatorio"}),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            if password is None or password == "":
                return (
                    jsonify({"msg": "La contraseña es obligatoria"}),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            if user is None:
                ...
                if user is None:
                    return (
                        jsonify({"msg": "Email o contraseña incorrectos"}),
                        401,
                        {"ContentType": "application/json"},
                    )
                ...
                user_info = {
                    ...
                    "apellido": user.get_hijo().apellido
                    if type(user.get_hijo()).__name__ == "Usuario"
                    else "",
                ...
                return (
                    jsonify(
                        {
                            "msg": "Inicio de sesion con codigo de recuperación. Debe actualizar su contraseña",
                            "user_info": user_info,
                            "email": user.email,
                        }
                    ),
            ...
            response = jsonify(
                {"msg": "Login exitoso", "token": access_token, "user_info": user_info}
            )
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error validando los datos"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def validateRegisterOrganizacion(form):
        ...
        if nombreOrganizacion is None or nombreOrganizacion == "":
            return (
                jsonify({"msg": "El nombre de la organizacion es obligatorio"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        if descripcion is None or descripcion == "":
            return (
                jsonify({"msg": "La descripcion es obligatoria"}),
                400,
                {"ContentType": "application/json"},
            )
        email = request.form.get("email", None)
        ...
        if geo_lat is None or geo_lat == "" or geo_long is None or geo_long == "":
            return (
                jsonify({"msg": "La ubicacion es obligatoria"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        if dniResponsable is None or dniResponsable == "":
            return (
                jsonify({"msg": "El dni del responsable es obligatorio"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        if nombreResponsable is None or nombreResponsable == "":
            return (
                jsonify({"msg": "El nombre del responsable es obligatorio"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        if apellidoResponsable is None or apellidoResponsable == "":
            return (
                jsonify({"msg": "El apellido del responsable es obligatorio"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        if fecha_creacion is None or fecha_creacion == "":
            return (
                jsonify({"msg": "La fecha de creacion es obligatoria"}),
                400,
                {"ContentType": "application/json"},
            )
        try:
            ...
            return (
                jsonify({"msg": "La fecha de creacion no es valida"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def validateRegisterUsuario(form):
        ...
        if nombre is None or nombre == "":
            return (
                jsonify({"msg": "El nombre es obligatorio"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        if apellido is None or apellido == "":
            return (
                jsonify({"msg": "El apellido es obligatorio"}),
                400,
                {"ContentType": "application/json"},
            )
        email = request.form.get("email", None)
        ...
        if fecha_nacimiento is None or fecha_nacimiento == "":
            return (
                jsonify({"msg": "La fecha de nacimiento es obligatoria"}),
                400,
                {"ContentType": "application/json"},
            )
        try:
            ...
            return (
                jsonify({"msg": "La fecha de nacimiento no es valida"}),
                400,
                {"ContentType": "application/json"},
            )
        password = request.form.get("password", None)
    ...
    def register():
        try:
            ...
            if email is not None:
                # Iniciar sesion
                access_token = (
                    create_access_token(identity=[email, usuario.padre_id])
                    if usuario is not None
                    else create_access_token(identity=[email, organizacion.padre_id])
                )
                user_info = {
                    "id": usuario.padre_id
                    if usuario is not None
                    else organizacion.padre_id,
                    "nombre": usuario.nombre
                    if usuario is not None
                    else organizacion.nombre,
                    "apellido": usuario.apellido if usuario is not None else "",
                    "es_organizacion": organizacion is not None,
                }
                response = jsonify(
                    {
                        "msg": "Registro finalizado exitosamente",
                        "token": access_token,
                        "user_info": user_info,
                    }
                )
                ...
                return (
                    jsonify({"msg": "Faltan datos para completar el registro"}),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error registrando los datos"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def recuperar():
        try:
            ...
            if email is None or email == "":
                return (
                    jsonify({"msg": "Email es obligatorio"}),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            if user is None:
                return (
                    jsonify(
                        {"msg": "El email ingresado no pertenece a ninguna cuenta"}
                    ),
                    400,
                    {"ContentType": "application/json"},
                )
                ...
                if email_service.enviar_mail_recuperacion(user, tempPass):
                    return (
                        jsonify({"msg": "Email enviado exitosamente"}),
                        200,
                        {"ContentType": "application/json"},
                    )
                else:
                    return (
                        jsonify(
                            {
                                "msg": "Ocurrio un error al enviar el mail de recuperacion"
                            }
                        ),
                        400,
                        {"ContentType": "application/json"},
            ...
            return (
                jsonify(
                    {"msg": "Ocurrio un error en la recuperacion de la contraseña"}
                ),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def resetPassword():
        try:
            ...
            if id is None or token is None or token == "":
                return (
                    jsonify({"msg": "Faltan datos para realizar la busqueda"}),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            if new_password is None or new_password == "":
                return (
                    jsonify({"msg": "La nueva contraseña es obligatoria"}),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            if duplicated_new_password is None or duplicated_new_password == "":
                return (
                    jsonify(
                        {"msg": "La confirmacion de la nueva contraseña es obligatoria"}
                    ),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            if new_password != duplicated_new_password:
                return (
                    jsonify({"msg": "Las contraseñas no coinciden"}),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            if user is None:
                return (
                    jsonify({"msg": "No fue posible actualizar la contraseña"}),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            return (
                jsonify({"msg": "Contraseña actualizada correctamente"}),
                200,
                {"ContentType": "application/json"},
            )
        except:
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al actualizar password"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def listado_perdidos_y_encontrados():
        try:
            ...
            publicaciones = Publicacion.allEnabledPerdidosYEncontradosCerca(
                geo_lat, geo_long
            )
            return (
                jsonify(
                        ...
                        "publicaciones": [
                            {
                                ...
                                "distancia": round(each[1], 2)
                                if round(each[1], 2) > 1
                                else "Menos de 1",
                            }
                            for each in publicaciones
                            if each[0].vencimiento is None
                            or each[0].vencimiento > datetime.now()
                        ]
                    }
                ),
                200,
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error listando perdidos y encontrados"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def listado_adopcion_y_transito():
        try:
            geo_lat = request.args.get("geo_lat", 0.0)
            geo_long = request.args.get("geo_long", 0.0)
            publicaciones = Publicacion.allEnabledAdopcionYTransitoCerca(
                geo_lat, geo_long
            )
            return (
                jsonify(
    ...
    def mis_publicaciones():
        try:
            ...
            publis = user.publicaciones
            publis.sort(key=lambda p: p.created_at, reversed=True)
            return (
                jsonify([p.to_dict() for p in publis if p.enabled]),
                200,
                {"ContentType": "application/json"},
            )
        except:
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al recuperar el perfil del usuario"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def nuevaPublicacion(tipo):
        try:
            if int(tipo) != 2 and get_jwt_identity() is None:
                return (
                    jsonify({"msg": "Debe iniciar sesion primero"}),
                    401,
                    {"ContentType": "application/json"},
                )
            ...
            if int(tipo) == 2 or request.form.get("id_mascota", None) is None:
                ...
                publicacion = Publicacion(
                    ...
                    tipo=int(tipo),
                    estadoGeneral=1,
                    castracion=request.form.get("castracion", None) == "true"
                    if int(tipo) in (3, 4)
                    else None,
                    vacunacion=request.form.get("vacunacion", None)
                    if int(tipo) in (3, 4)
                    else None,
                    patologias=request.form.get("patologias", None)
                    if int(tipo) in (3, 4)
                    else None,
                    medicacion=request.form.get("medicacion", None)
                    if int(tipo) in (3, 4)
                    else None,
                    duracion_transito=request.form.get("duracion_transito", None)
                    if int(tipo) == 4
                    else None,
                    ...
                    mascota_id=None,
                    retuvo=request.form.get("retuvo", None) == "true"
                    if int(tipo) == 2
                    else None,
                    contacto_anonimo=request.form.get("contacto_anonimo", None)
                    if int(tipo) == 2
                    and request.form.get("contacto_anonimo", None) != "undefined"
                    and request.form.get("contacto_anonimo", None) != "null"
                    else None,
                )

                if "imagen" not in request.files:
                    return (
                        jsonify({"msg": "La imagen es obligatoria"}),
                        400,
                        {"ContentType": "application/json"},
                    )
                ...
                if file and file.content_type.startswith("image"):
                    if file.content_type != "image/jpeg":
                        return (
                            jsonify({"msg": "La imagen ingresada no es JPG"}),
                            400,
                            {"ContentType": "application/json"},
                        )
                else:
                    return (
                        jsonify({"msg": "El archivo ingresado no es una imagen"}),
                        400,
                        {"ContentType": "application/json"},
                    )
                ...
                return jsonify(
                    {
                        "new": True,
                        "publicacion": publicacion.to_dict(),
                        "cant_similares": len(similares),
                        "similares": similares,
                    }
                )

            mascota: Mascota = Mascota.buscarMascotaPorID(
                request.form.get("id_mascota", None)
            )
            if mascota is None:
                return (
                    jsonify({"msg": "Error al generar la publicacion"}),
                    400,
                    {"ContentType": "application/json"},
                )

            years = (
                round((datetime.now() - mascota.fecha_nacimiento).days / 365)
                if (datetime.now() - mascota.fecha_nacimiento).days % 365 < 183
                else round((datetime.now() - mascota.fecha_nacimiento).days / 365) - 1
            )
            if years == 0:
                months = (
                    round((datetime.now() - mascota.fecha_nacimiento).days / 30)
                    if (datetime.now() - mascota.fecha_nacimiento).days % 30 < 15
                    else round((datetime.now() - mascota.fecha_nacimiento).days / 30)
                    - 1
                )
                if months == 1:
                    edad_value = months
            ...
            publi_existente: Publicacion = (
                Publicacion.buscarPublicacionActivaPorMascota(mascota.id, int(tipo))
            )
            if publi_existente is None:
                ...
                return jsonify(
                    {
                        "new": False,
                        "publicacion": publi_existente.to_dict(),
                        "cant_similares": len(similares),
                        "similares": similares,
                    }
                )
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error creando la publicacion"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def publicacionesParecidas(publicacion: Publicacion):
        if publicacion.tipo == 3 or publicacion.tipo == 4:
            return []
        publis = Publicacion.allEnabledEnRango(
            publicacion.geo_lat, publicacion.geo_long, 10, [2, 1][publicacion.tipo - 1]
        )

        publis_1er_filtro = [
            p
            for p in publis
            if p[0].tipo_mascota_id == publicacion.tipo_mascota_id
            and p[0].sexo == publicacion.sexo
            and (
                (round((datetime.now() - p[0].created_at).total_seconds()) / 3600 < 48)
                if publicacion.tipo == 1 and p[0].vencimiento is not None
                else True
            )
            and p[0].id != publicacion.id
        ]
        ...
        for p in publis_1er_filtro:
            ...
            if p[0].nombre != "---" and publicacion.nombre != "---":
                if p[0].nombre.upper().strip().replace(
                    " ", ""
                ) == publicacion.nombre.upper().strip().replace(" ", ""):
                    coincidencia = coincidencia + 15.0
            ...
            for each in publicacion.colores.split(", "):
                if each in p[0].colores.split(", "):
                    coincidencia = coincidencia + (
                        20 / len(publicacion.colores.split(", "))
                    )
        ...
        publis_coincidencia_seleccionadas = [
            p for p in publis_con_coincidencia if p["coincidencia"] > 50
        ]

        publis_coincidencia_seleccionadas.sort(
            key=lambda p: (-p["coincidencia"], p["distancia"])
        )
    ...
    def detallePublicacion(id):
        try:
            ...
            if publicacion is None:
                return (
                    jsonify({"msg": "Publicacion con id {} inexistente".format(id)}),
                    205,
                    {"ContentType": "application/json"},
                )
            ...
            if publicacion.estadoGeneral == 2:
                if (
                    get_jwt_identity() is None
                    or get_jwt_identity()[1] != publicacion.publicador_id
                ):
                    return (
                        jsonify(
                            {"msg": "Publicacion con id {} inexistente".format(id)}
                        ),
                        205,
                        {"ContentType": "application/json"},
                    )
            ...
            if (
                publicacion.vencimiento is not None
                and publicacion.vencimiento < datetime.now()
            ):
                if (
                    get_jwt_identity() is None
                    or get_jwt_identity()[1] != publicacion.publicador_id
            ...
            return (
                jsonify(
                    {"msg": "Ocurrio un error al obtener el detalle la publicacion"}
                ),
                400,
                {"ContentType": "application/json"},
            )
        ...
        try:
            ...
            if publicacion is None:
                return (
                    jsonify(
                        {
                            "msg": "No existe una publicacion con id {} en el sistema".format(
                                id
                            )
                        }
                    ),
            ...
            if (
                ...
                return (
                    jsonify(
                        {
                            "msg": "La publicacion con id {} se encuentra vencida".format(
                                id
                            )
                        }
                    ),
                ...
                return (
                    jsonify(
                        {
                            "msg": "El usuario iniciado no tiene permiso para acceder a editar la publicacion {}".format(
                                id
                            )
                        }
                    ),
            ...
            if request.form.get("id_mascota", None) is not None:
                if int(request.form.get("id_mascota", None)) != publicacion.mascota_id:
                    ...
                    if mascota is None:
                        return (
                            jsonify({"msg": "Error al actualizar la publicacion"}),
                            400,
                            {"ContentType": "application/json"},
                        )
                    ...
                    years = (
                        ...
                        if (datetime.now() - mascota.fecha_nacimiento).days % 365 < 183
                            ...
                            (datetime.now() - mascota.fecha_nacimiento).days / 365
                        )
                        - 1
                    )
                    if years == 0:
                        months = (
                            round((datetime.now() - mascota.fecha_nacimiento).days / 30)
                            if (datetime.now() - mascota.fecha_nacimiento).days % 30
                            < 15
                            else round(
                                (datetime.now() - mascota.fecha_nacimiento).days / 30
                            )
                            - 1
                        )
                        if months == 1:
                    ...
                    publicacion.duracion_transito = request.form.get(
                        "duracion_transito", None
                    )
                    ...
                    if publicacion.geo_lat != request.form.get(
                        "geo_lat"
                    ) or publicacion.geo_long != request.form.get("geo_long"):
                ...
                if publicacion.tipo != 2:
                    ...
                    publicacion.contacto_anonimo = (
                        request.form.get("contacto_anonimo", None)
                        if request.form.get("contacto_anonimo", None) != "undefined"
                        and request.form.get("contacto_anonimo", None) != "null"
                        else None
                    )
                print(request.form.get("colores", None))
                ...
                publicacion.caracteristicas = (
                    request.form.get("caracteristicas", None)
                    if request.form.get("caracteristicas", None) != "undefined"
                    and request.form.get("caracteristicas", None) != "null"
                    else None
                )
                publicacion.geo_lat = request.form.get("geo_lat", None)
                publicacion.geo_long = request.form.get("geo_long", None)
                if publicacion.tipo in (3, 4):
                    publicacion.castracion = (
                        request.form.get("castracion", None) == "true"
                    )
                    publicacion.vacunacion = (
                        request.form.get("vacunacion", None)
                        if publicacion.tipo in (3, 4)
                        else None
                    )

                    if (
                        request.form.get("patologias", None) != "undefined"
                        and request.form.get("patologias", None) != "null"
                    ):
                        publicacion.patologias = request.form.get("patologias", None)
                    if (
                        request.form.get("medicacion", None) != "undefined"
                        and request.form.get("medicacion", None) != "null"
                    ):
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al editar la publicacion"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def eliminarPublicacion(id):
        try:
            ...
            if publicacion.eliminar():
                return (
                    jsonify({"msg": "Publicacion eliminada con exito"}),
                    200,
                    {"ContentType": "application/json"},
                )
            return (
                jsonify({"msg": "Ocurrio un error al eliminar la publicacion"}),
                400,
                {"ContentType": "application/json"},
            )
        except:
        ...
        try:
            ...
            if publicacion is None or not publicacion.enabled:
                ...
                return (
                    jsonify(
                        {
                            "msg": "El usuario iniciado no tiene permiso para acceder a pausar la publicacion {}".format(
                                id
                            )
                        }
                    ),
                ...
                return (
                    jsonify(
                        {
                            "msg": "Solo puede pausarse una publicacion que se encuentre activa"
                        }
                    ),
                    401,
                    {"ContentType": "application/json"},
            ...
            return (
                jsonify({"msg": "Publicacion pausada con exito"}),
                200,
                {"ContentType": "application/json"},
            )
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al pausar la publicacion"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        try:
            ...
            if publicacion is None or not publicacion.enabled:
                ...
                return (
                    jsonify(
                        {
                            "msg": "El usuario iniciado no tiene permiso para acceder a reanudar la publicacion {}".format(
                                id
                            )
                        }
                    ),
                ...
                return (
                    jsonify(
                        {
                            "msg": "Solo puede reanudarse una publicacion que se encuentre pausada"
                        }
                    ),
                    401,
                    {"ContentType": "application/json"},
            ...
            return (
                jsonify({"msg": "Publicacion reanudada con exito"}),
                200,
                {"ContentType": "application/json"},
            )
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al reanudada la publicacion"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        try:
            ...
            if publicacion is None or not publicacion.enabled:
                ...
                return (
                    jsonify(
                        {
                            "msg": "El usuario iniciado no tiene permiso para acceder a finalizar la publicacion {}".format(
                                id
                            )
                        }
                    ),
                ...
                return (
                    jsonify(
                        {
                            "msg": "Solo puede finalizarse una publicacion que se encuentre activa"
                        }
                    ),
                    401,
                    {"ContentType": "application/json"},
            ...
            return (
                jsonify({"msg": "Publicacion finalizada con exito"}),
                200,
                {"ContentType": "application/json"},
            )
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al finalizada la publicacion"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def listado_organizaciones():
        try:
                        ...
                        "organizaciones": [
                            {
                                    ...
                                    "1": len(
                                        list(
                                            filter(
                                                lambda p: p.tipo == 1
                                                and p.enabled
                                                and p.estadoGeneral == 1,
                                                each.padre.publicaciones,
                                            )
                                        )
                                    ),
                                    "2": len(
                                ...
                                "distancia": round(each.distancia, 2)
                                if round(each.distancia, 2) > 1
                                else "Menos de 1",
                            }
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error listando organizaciones"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def perfil(id):
        try:
            ...
            if usuario is not None:
                return (
                    jsonify(usuario.complete_dict_filtrado()),
                    200,
                    {"ContentType": "application/json"},
                )

            return (
                jsonify({"msg": "No se encontro el usuario"}),
                404,
                {"ContentType": "application/json"},
            )
        except:
    ...
    def mi_perfil():
        try:
            usuario: UsuarioPadre = UsuarioPadre.buscarUsuarioPorID(
                get_jwt_identity()[1]
            )
            return (
                jsonify(usuario.complete_dict()),
                200,
                {"ContentType": "application/json"},
            )
        except:
    ...
    def actualizarPassword():
        try:
            if (
                request.form.get("actual_password") is None
                or request.form.get("new_password") is None
                or request.form.get("actual_password") == ""
            ...
            if UsuarioPadre.comprobarContraseña(
                get_jwt_identity()[1], request.form.get("actual_password")
            ):
                if request.form.get("actual_password") == request.form.get(
                    "new_password"
                ):
                    return (
                        jsonify(
                ...
                UsuarioPadre.updatePassword(
                    get_jwt_identity()[1], request.form.get("new_password")
                )
            else:
                return (
                    jsonify({"msg": "La contraseña actual es incorrecta"}),
                    400,
                    {"ContentType": "application/json"},
                )
            return (
    ...
    def editarPerfil():
        try:
            ...
            if request.form.get("es_organizacion") == "true":
                organizacion = Organizacion.buscarOrganizacionPorIDPadre(
                    get_jwt_identity()[1]
                )
            ...
            return (
                jsonify({"msg": "Ocurrio un error, no se pudo encontrar al usuario"}),
                400,
                {"ContentType": "application/json"},
            )
        except:
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al editar el perfil"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def getDateOrDefault(request, name, default=None):
        if request.form.get(name) is not None:
            return datetime(
                int(request.form.get(name).split("-")[0]),
    ...
    def editarPerfilUsuario(usuario, request):
        if usuario is None:
            return (
                jsonify({"msg": "El usuario {} no existe en el sistema".format(id)}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        if request.form.get("nombre") is None or request.form.get("nombre") == "":
            return (
                jsonify({"msg": "El nombre es un campo requerido"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        if request.form.get("apellido") is None or request.form.get("apellido") == "":
            return (
                jsonify({"msg": "El apellido es un campo requerido"}),
                400,
                {"ContentType": "application/json"},
            )

        if (
            request.form.get("fecha_nacimiento") is None
            or request.form.get("fecha_nacimiento") == ""
        ):
            return (
                jsonify({"msg": "La fecha de nacimiento es un campo requerido"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        usuario.fecha_nacimiento = getDateOrDefault(
            request, "fecha_nacimiento", usuario.fecha_nacimiento
        )
        usuario.padre.telefono = getOrDefault(request, "telefono", None)
        usuario.padre.instagram = getOrDefault(request, "instagram", None)
        usuario.padre.instagram_visible = getBooleanOrDefault(
            request, "instagram_visible", usuario.padre.instagram_visible
        )
        if usuario.padre.instagram_visible and usuario.padre.instagram is None:
            usuario.padre.instagram_visible = False
        usuario.padre.email_visible = getBooleanOrDefault(
            request, "email_visible", usuario.padre.email_visible
        )
        usuario.padre.telefono_visible = getBooleanOrDefault(
            request, "telefono_visible", usuario.padre.telefono_visible
        )
    ...
    def editarPerfilOrganizacion(organizacion, request):
        if organizacion is None:
            return (
                jsonify(
                    {"msg": "La organizacion {} no existe en el sistema".format(id)}
                ),
                400,
                {"ContentType": "application/json"},
            )
        ...
        if (
            request.form.get("geo_lat") is None
            or request.form.get("geo_lat") == ""
            or request.form.get("geo_long") is None
            or request.form.get("geo_long") == ""
        ):
            return (
                jsonify({"msg": "La ubicacion es requerida"}),
                400,
                {"ContentType": "application/json"},
            )

        if (
            request.form.get("descripcion_breve") is None
            or request.form.get("descripcion_breve") == ""
        ):
            return (
                jsonify({"msg": "La descripcion breve es un campo requerido"}),
                400,
                {"ContentType": "application/json"},
            )

        if (
            request.form.get("dni_responsable") is None
            or request.form.get("dni_responsable") == ""
        ):
            return (
                jsonify({"msg": "El dni del responsable es un campo requerido"}),
                400,
                {"ContentType": "application/json"},
            )

        if (
            request.form.get("nombre_responsable") is None
            or request.form.get("nombre_responsable") == ""
        ):
            return (
                jsonify({"msg": "El nombre del responsable es un campo requerido"}),
                400,
                {"ContentType": "application/json"},
            )

        if (
            request.form.get("apellido_responsable") is None
            or request.form.get("apellido_responsable") == ""
        ):
            return (
                jsonify({"msg": "El apellido del responsable es un campo requerido"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        organizacion.descripcion_breve = getOrDefault(
            request, "descripcion_breve", organizacion.descripcion_breve
        )
        ...
        organizacion.nombre_responsable = getOrDefault(
            request, "nombre_responsable", organizacion.nombre_responsable
        )
        organizacion.apellido_responsable = getOrDefault(
            request, "apellido_responsable", organizacion.apellido_responsable
        )
        organizacion.fecha_creacion = getDateOrDefault(
            request, "fecha_creacion", organizacion.fecha_creacion
        )

        organizacion.padre.telefono = getOrDefault(request, "telefono", None)
        organizacion.padre.telefono_visible = getBooleanOrDefault(
            request, "telefono_visible", organizacion.padre.telefono_visible
        )
        ...
        organizacion.padre.instagram_visible = getBooleanOrDefault(
            request, "instagram_visible", organizacion.padre.instagram_visible
        )

        if organizacion.padre.instagram is None or organizacion.padre.instagram == "":
            organizacion.padre.instagram_visible = False
        organizacion.padre.email_visible = getBooleanOrDefault(
            request, "email_visible", organizacion.padre.email_visible
        )
    ...
    def nuevaMascota():
        try:
            if (
                request.form.get("nombre", None) is None
                or request.form.get("nombre", None) == "null"
                and request.form.get("nombre", None) == "undefined"
            ):
                return (
                    jsonify({"msg": "Debe completar todos los campos"}),
                    400,
                    {"ContentType": "application/json"},
                )
            ...
            mascota = Mascota(
                request.form.get("nombre"),
                datetime(
                    int(request.form.get("fecha_nacimiento").split("-")[0]),
                ...
                request.form.get("caracteristicas")
                if request.form.get("nombre", None) is not None
                and request.form.get("nombre", None) != "null"
                and request.form.get("nombre", None) != "undefined"
                else None,
                request.form.get("castracion") == "true",
                request.form.get("vacunacion"),
                request.form.get("enfermedades")
                if request.form.get("enfermedades", None) is not None
                and request.form.get("enfermedades", None) != "null"
                and request.form.get("enfermedades", None) != "undefined"
                else None,
                request.form.get("cirugias")
                if request.form.get("cirugias", None) is not None
                and request.form.get("cirugias", None) != "null"
                and request.form.get("cirugias", None) != "undefined"
                else None,
                request.form.get("medicacion")
                if request.form.get("medicacion", None) is not None
                and request.form.get("medicacion", None) != "null"
                and request.form.get("medicacion", None) != "undefined"
                else None,
            ...
            if "imagen" not in request.files:
                return (
                    jsonify({"msg": "El request no tenia una imagen"}),
                    400,
                    {"ContentType": "application/json"},
                )
            file = request.files.get("imagen")
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al obtener crear una nueva mascota"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        try:
            ...
            if mascota is None or not mascota.enabled:
                return (
                    jsonify(
                        {
                            "msg": "La mascota no existe u ocurrio un error recuperando su informacion"
                        }
                    ),
                    400,
                    {"ContentType": "application/json"},
                ...
                UsuarioPadre.buscarUsuarioPorID(get_jwt_identity()[1])
                not in mascota.dueños
            ):
                return (
                    jsonify(
                        {
                            "msg": "El usuario iniciado no tiene permisos de ver esta mascota, solo sus dueños"
                        }
                    ),
                    400,
                    {"ContentType": "application/json"},
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al obtener el detalle la mascota"}),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def perfilMascotaQR(id):
        ...
        return render_template(
            ...
            contactos=mascota.get_contactos(),
        )
    ...
    def detalleMascotaQRTemplate(id):
        ...
        return render_template(
            "qr_download.html",
            direc="/mascota/detalle/{}/qr/obtener?jwt={}".format(id, jwt),
        )
    ...
    def detalleMascotaQR(id):
        try:
            ...
            qr.add_data(
                "https://betaapp.pythonanywhere.com/mascota/perfil/{}".format(id)
            )
            qr.make(fit=True)
            ...
            with io.BytesIO() as buffer:
                ...
                return Response(
                    ...
                    mimetype="image/jpeg",
                    headers={
                        "Content-Disposition": "attachment;filename=QR-Informacion-{}.jpeg".format(
                            mascota.nombre
                        )
                    },
                )
            ...
            return (
                jsonify(
                    {"msg": "Ocurrio un error al obtener el qr del detalle la mascota"}
                ),
                400,
                {"ContentType": "application/json"},
            )
    ...
    def misMascotas():
        user = UsuarioPadre.buscarUsuarioPorID(get_jwt_identity()[1])
        return (
            jsonify([m.to_dict() for m in user.mascotas if m.enabled]),
            200,
            {"ContentType": "application/json"},
        )
        ...
        try:
            ...
            if mascota is None:
                return (
                    jsonify(
                        {
                            "msg": "No existe una mascota con id {} en el sistema".format(
                                id
                            )
                        }
                    ),
                ...
                return (
                    jsonify(
                        {
                            "msg": "El usuario iniciado no tiene permiso para acceder a editar la mascota {}".format(
                                id
                            )
                        }
                    ),
            ...
            if (
                request.form.get("fecha_nacimiento", None) is not None
                and request.form.get("fecha_nacimiento", None) != "null"
            ):
                mascota.fecha_nacimiento = datetime(
                    int(request.form.get("fecha_nacimiento", None).split("-")[0]),
                    int(request.form.get("fecha_nacimiento", None).split("-")[1]),
                    int(request.form.get("fecha_nacimiento", None).split("-")[2]),
                )

            if (
                request.form.get("castracion", None) is not None
                and request.form.get("castracion", None) != "null"
            ):
                mascota.castracion = request.form.get("castracion", None) == "true"

            if (
                request.form.get("tipo_mascota", None) is not None
                and request.form.get("tipo_mascota", None) != "null"
            ):
                mascota.tipo_mascota_id = request.form.get("tipo_mascota", None)

            if (
                request.form.get("raza_mascota", None) is not None
                and request.form.get("raza_mascota", None) != "null"
            ):
            ...
            traceback.print_exc()
            return (
                jsonify({"msg": "Ocurrio un error al editar la mascota"}),
                400,
                {"ContentType": "application/json"},
            )
        ...
        try:
            ...
            if mascota is None or not mascota.enabled:
                ...
                return (
                    jsonify(
                        {
                            "msg": "El usuario iniciado no tiene permiso para acceder a eliminar la mascota {}".format(
                                id
                            )
                        }
                    ),
            ...
            try:
                ...
                if len(mascota.dueños) == 0:
                    mascota.eliminar()
                return (
                    jsonify({"msg": "Mascota eliminada con exito"}),
                    200,
                    {"ContentType": "application/json"},
                )
            except:
                return (
                    jsonify({"msg": "Ocurrio un error al eliminar la mascota"}),
                    400,
                    {"ContentType": "application/json"},
                )
        except:
        ...
        try:
            ...
            if (
                ...
                return (
                    jsonify(
                        {
                            "msg": "Debe ser dueño de la mascota {} para obtener el qr de añadido rapido".format(
                                id
                            )
                        }
                    ),
            ...
            verificador = generate_password_hash(
                str(UsuarioPadre.buscarUsuarioPorID(get_jwt_identity()[1]).to_dict()),
                "sha256",
                32,
            ).replace("sha256$", "")
            ...
            qr.add_data(
                "https://betaapp.pythonanywhere.com/mascota/agregado_rapido/{0}/{1}".format(
                    id, verificador
                )
            )
            qr.make(fit=True)
            ...
            return (
                jsonify(
                    {
                        "msg": "Ocurrio un error al obtener el qr para añadir un dueño a la mascota"
                    }
                ),
                400,
                {"ContentType": "application/json"},
        ...
        try:
            ...
            if usuario in mascota.dueños:
                return (
                    jsonify(
                        {
                            "msg": "El usuario iniciado ya es dueño de la mascota seleccionada"
                        }
                    ),
                    400,
                    {"ContentType": "application/json"},
            ...
            for owner in mascota.dueños:
                if check_password_hash("sha256$" + verificador, str(owner.to_dict())):
                    ...
                    usuario.save()
                    return (
                        jsonify([m.to_dict() for m in usuario.mascotas if m.enabled]),
                        200,
                        {"ContentType": "application/json"},
                    )
            ...
            return (
                jsonify(
                    {
                        "msg": "El qr obtenido no fue generado por un dueño de la mascota indicada"
                    }
                ),
                400,
                {"ContentType": "application/json"},
    ...
    def razasPorTipoMascota(tipo_mascota):
        ...
        raza_mestizo = Raza_Mascota.query.filter_by(
            tipo_mascota_id=tipo_mascota, raza="Mestizo"
        ).first()
        ...
        return (
            jsonify({"razas": [r.to_dict() for r in razas]}),
            200,
            {"ContentType": "application/json"},
        )
    ...
    def tipos():
        ...
        return (
            jsonify({"tipos": [t.to_dict() for t in tipos]}),
            200,
            {"ContentType": "application/json"},
        )
    ...
    def colores():
        ...
        return (
            jsonify(
                {
                    "colores": [
                        {"id": i + 1, "nombre": colores[i]} for i in range(len(colores))
                    ]
                }
            ),
            200,
    ...
    def resize_and_save_image(file):
        try:
            ...
            if exif_dict is not None:
                ...
                if (
                    piexif.ImageIFD.Orientation in exif_data["0th"]
                    ...
                    if orientation == 2:
                        ...
                        original_image = original_image.rotate(180).transpose(
    ...
    def imagennueva():
        return str(
            resize_and_save_image(request.files.get("imagen").read()) is not None
        )
    ...
    def descargar_android():
        ...
        try:
            return send_from_directory(
                directory="static", path="BETA.apk", as_attachment=True
            )
        except:
            import traceback
